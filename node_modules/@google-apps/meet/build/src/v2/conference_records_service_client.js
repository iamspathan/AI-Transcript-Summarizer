 ...
 * `src/v2/conference_records_service_client_config.json`.
...
class ConferenceRecordsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.apps.meet.v2.ConferenceRecordsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conferenceRecordsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.apps.meet.v2.ConferenceRecordsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.apps.meet.v2.ConferenceRecordsService, this._opts, this._providedCustomServicePath);
