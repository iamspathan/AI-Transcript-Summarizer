...
exports.SpacesServiceClient = void 0;
 ...
 */
const gapicConfig = require("./spaces_service_client_config.json");
...
class SpacesServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.apps.meet.v2.SpacesService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.spacesServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.apps.meet.v2.SpacesService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.apps.meet.v2.SpacesService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of spacesServiceStubMethods) {
            const callPromise = this.spacesServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    endActiveConference(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.SpacesServiceClient = SpacesServiceClient;
//# sourceMappingURL=spaces_service_client.js.map